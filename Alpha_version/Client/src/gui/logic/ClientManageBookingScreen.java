...
public class ClientManageBookingScreen {
	...
	@FXML
    void onCheck(Event event) { // Matches FXML onAction="#onCheck"
    ...
    void onConfirm(Event event) { // Matches FXML onAction="#onConfirm"
        ...
        // Call controller to update (You will need to implement updateReservation in Reservation_Controller)
        // BistroClientGUI.client.getReservationCTRL().updateReservation(currentOrder.getOrderNumber(), date, selectedTimeSlot, diners);
    ...
    private void refreshTimeSlots() {
        ...
        // In a real scenario, you would use the async callback here too (like in NewReservationScreen)
    ...
    private List<String> generateDefaultTimeSlots() {
        ...
        times.add("18:00"); times.add("18:30"); times.add("19:00");
        return times;
    }
